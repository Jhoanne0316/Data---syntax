...
gen double amtspentperdish=round(quantity*defdishcost,0.0001) /*investment shares is based on this variable*/
...
gen totalamountspent=amtspentperdish1+ amtspentperdish2+ amtspentperdish3+ amtspentperdish4+ amtspentperdish5
