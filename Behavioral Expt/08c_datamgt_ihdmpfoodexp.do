...
gen double hed=round(sqrt(hdis_starch+ hdis_nonveg+ hdis_pulses+ hdis_dairy+ hdis_veg+ hdis_fruit+ hdis_savings),0.0001)
gen double wed=round(sqrt(wdis_starch+ wdis_nonveg+ wdis_pulses+ wdis_dairy+ wdis_veg+ wdis_fruit+ wdis_savings),0.0001)
...
label variable midmp_fexp "Men’s intrahousehold decision making power"
label variable widmp_fexp "Women’s intrahousehold decision making power"
