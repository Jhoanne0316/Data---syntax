...
gen      double energyspent  =round(energyspent*quantity, 0.0001)


***computing the energy spent per occasion per day for each respondent
collapse (sum) carbkcal prokcal fatkcal energyspent (mean)occ, by (uniqueID day)


***computing the energy spent per occasion for each respondent
sort     uniqueID occasion 
collapse (mean) carbkcal prokcal fatkcal energyspent (mean) occ, by (uniqueID)
